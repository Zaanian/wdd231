const weburl = 'https://byui-cse.github.io/cse-ww-program/data/latter-day-prophets.json';
...
const displayProphets = (prophets) => {
    prophets.forEach((prophet) => {
        ...
        fullName.textContent = `${prophet.name} ${prophet.lastname} ____________`; // fill in the blank
